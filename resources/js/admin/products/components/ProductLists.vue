               ...
               >
                  ...
                  <!--<template slot="items" slot-scope="props">-->
                     <tr>
                        ...
                        <td>
                           <v-chip small>{{ item.brand_id }}</v-chip>
                        </td>
                        <td>
                        ...
                        <td>
                           <router-link
                              ...
                              >{{ item.created_by }}</router-link></td>
                        <td class="text-right">
                           <v-btn
                              tile
                              color="primary"
            ...
            <v-col cols="9" sm="12">
               ...
               <v-form>
                  <v-card>
                     ...
                     <v-row>
                        <v-col cols="12">
                           <v-text-field clearable v-model="filters.name" label="Name"></v-text-field>
                        </v-col>
                        <v-col cols="12">
                           <v-text-field clearable v-model="filters.asin" label="ASIN #"></v-text-field>
                        </v-col>
                        <v-col cols="12">
                           <v-select
                              multiple
                     ...
                     <v-card-actions>
                        <v-col cols="12">
                           <v-btn small text color="grey darken-1">
